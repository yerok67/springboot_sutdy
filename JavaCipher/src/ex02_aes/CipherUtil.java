...
public class CipherUtil {
	...
	private final static byte[] iv = new byte[] { (byte) 0x8E, 0x12, 0x39, (byte) 0x90, 0x07, 0x72, 0x6F, (byte) 0x5A,
	...
	public static String decrypt(String cipherMsg) {
		...
		return new String(plainMsg).trim(); // byte[]형태의 평균 => 문자열
	}

	// 비트형태데이터 => 16진수 형태의 문자열 변환
	...
	public static void encryptFile(String plainFile, String cipherFile, String strkey) {
		try {
			...
			// CipherOutputStream : 암호화 스트림. cipher 객체의 암호화 모드
