...
public interface UserRepository extends JpaRepository<User, String> {
	...
	List<User> searchByUserid(@Param("email") String email, @Param("phoneno") String phoneno);

	@Query("select u.password from Usercipher u "
			+ "where u.userid=:userid and u.email = :email and u.phoneno = :phoneno")
	String searchByPassword(@Param("userid") String userid, @Param("email") String email,
