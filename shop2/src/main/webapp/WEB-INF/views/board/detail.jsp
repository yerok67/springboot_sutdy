...
<%-- 1. http://localhost:8080/board/detail?num=1 요청 
	    - service.getBoard(num)
          ...
          num 파라미터에 해당 게시물을 정보 db에서 읽어 Board 객체에 저장
        - 조회 수 증가
          service.addReadnct(num)
          boardDao.addReadcnt(num)
          
       Controller, BoradService, BoardDao, BoardMapper 구현하기
--%>
...
<body>
	<table class="w3-table">
		...
		<tr>
			<td>내용</td>
			<td class="leftcol leftcoltable">${board.content}</td>
		</tr>
		<tr>
			<td>첨부파일</td>
		...
		<tr>
			...
			<a href="list?num=${board.boardid}">[게시물목록]</a>
	</table>
</body>
</html>
