...
<body>
	<table>
		<tr>
			<td id="tab1" class="tab"><a href="javascript:disp_div('minfo','tab1')" class="title">회원정보</a></td>
			<c:if test="${param.userid != 'admin'}">
				<td id="tab2" class="tab"><a href="javascript:disp_div('oinfo','tab2')" class="title">주문정보</a></td>
			</c:if>
		</tr>
	</table>
		...
		<table>
			...
			<c:forEach items="${salelist}" var="sale" varStatus="stat">
				<tr>
					...
					<td align="right"><fmt:formatNumber value="${sale.total}" pattern="###,###" />원</td>
				</tr>
	...
	<div id="minfo" class="info">
		...
		<br> <a href="logout">[로그아웃]</a>&nbsp; <a href="update?userid=${user.userid}">[회원정보수정]</a>&nbsp; <a href="password">[비밀번호수정]</a>&nbsp;
