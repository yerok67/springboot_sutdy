...
<body class="w3-light-grey">
	...
	<div class="w3-bar w3-top w3-black w3-large" style="z-index: 4">
		...
		<span class="w3-bar-item w3-right"> <c:if test="${empty sessionScope.loginUser}">
	...
	<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index: 3; width: 300px;"
		...
		<div class="w3-container w3-row">
			<div class="w3-col s4">
				<img src="${path}/img/logo.png" class="w3-margin-right" style="width: 80px">
			</div>
		...
		<div class="w3-bar-block">
			...
			<a href="${path}/user/mypage?userid=${loginUser.userid}"
				class="w3-bar-item w3-button w3-padding <c:if test='${url == "user"}'>w3-blue</c:if>"> <i
				class="fa fa-users fa-fw"></i>&nbsp; 회원관리
			</a> <a href="${path}/item/list"
				class="w3-bar-item w3-button w3-padding <c:if test='${url == "item"}'>w3-blue</c:if>"> <i
				class="fa fa-eye fa-fw"></i>&nbsp; 상품관리
			</a> <a href="${path}/chat/chat"
				class="w3-bar-item w3-button w3-padding <c:if test='${url == "chat"}'>w3-blue</c:if>"> <i
				class="fa fa-eye fa-fw"></i>&nbsp; 채팅하기
			</a>
			<hr>
		...
		<hr>
		<a href="${path}/chat/chatbot" class="w3-bar-item w3-button w3-padding "><i
			class="fa fa-comments fa-fw"></i>&nbsp; 챗봇</a>
		<hr>
		<a href="${path}/naver/search" class="w3-bar-item w3-button w3-padding "> <i
	...
	<div class="w3-main" style="margin-left: 300px; margin-top: 43px;">
		...
		<header class="w3-container" style="padding-top: 22px">
			<h5>
				<b><i class="fa fa-dashboard"></i>게시판현황</b>
			</h5>
		</header>
		<div class="w3-row-padding w3-margin-bottom">
			...
			<div class="w3-half">
				<div class="w3-container w3-padding-16 w3-center">
					...
					&nbsp;&nbsp;
					<div id="barcontainer" style="width: 100%; border: 1px solid #ffffff"></div>
				</div>
			</div>
		</div>
		<div class="w3-panel">
